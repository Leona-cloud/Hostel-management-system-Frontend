  ...
  return (
    <div className='w-full py-16 px-10 '>
         <div className='title'>
            ...
            <p className='text-[#475569] text-sm'>Manage your students from here</p>
         </div>
         ...
         <div className='flex items-center gap-5  mt-10'>
         <div className='border p-16'><Link to='/admin-dashboard/evict-student'>Evict Student</Link></div>
         </div>
    </div>
  )
}
